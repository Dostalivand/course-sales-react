...
import TeacherPhoto from '../../Images/teacher-4.png'
import coursePhoto from '../../Images/course-photo-7.jpeg'


export default function AltcoinTrainingCourse() {
            ...
            <div className='bg-gray-100 dark:bg-zinc-700'>
                <div className='container px-4' dir='rtl'>
                                ...
                                <div key={product.id}>
                                    <div>
                                        <div className="flex justify-between mb-1">
                                            ...
                                            <span className="text-base text-orange-400">75%</span>
                                        </div>
                                        <div className="w-full mb-5 bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                            <div className="bg-orange-400 h-2.5 rounded-full" style={{ width: '75%' }} />
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex justify-between items-center my-3 bg-gray-200 dark:bg-gray-600 w-full rounded gap-1 p-2'>
                                        ...
                                        <div className='text-gray-700 dark:text-gray-200'>1780</div>
                                    </div>
                                    <div className='flex justify-between items-center my-3 bg-gray-200 dark:bg-gray-600 w-full rounded gap-1 p-2'>
                                        <div className='flex items-center gap-1'>
                                            <div className='text-orange-400'>
                                        ...
                                        <div className='text-gray-700 dark:text-gray-200'>8 ساعت و 35 دقیقه</div>
                                    </div>
                                    <div className='flex justify-between items-center my-3 mb-0 bg-gray-200 dark:bg-gray-600 w-full rounded gap-1 p-2'>
                                        ...
                                        <div className='text-gray-700 dark:text-gray-200'>1403/12/08</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <DescriptionCourseBox
                        courseTitle='معرفی و آموزش انواع آلت کوین ها'
                        coursePhoto={coursePhoto}
                        teacherPhoto={TeacherPhoto}
                        teacherName='احمد اکبری'
                    />
                </div>
                <Footer />
            </div>
